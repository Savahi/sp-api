...
typedef int (*callback_ptr) (ServerData* data);
...
struct StartServerData {
  ...
  SERVER_DLL_START StartFunction;

  StartServerData ()
    : hServerDLL (0) {}
  bool StartServer (bool api);
  void StopServer ();
};
...
extern StartServerData WebData;
extern StartServerData ApiData;
